...
enum class SceneEffect : uint8_t
{
    ...
    DropShadow         ///< Apply a drop shadow effect with a Gaussian Blur filter. Param(8) = {color_R(int)[0 - 255], color_G(int)[0 - 255], color_B(int)[0 - 255], opacity(int)[0 - 255], angle(float)[0 - 1], distance(float), blur_sigma(float)[> 0], quality(int)[0 - 100]}
};
