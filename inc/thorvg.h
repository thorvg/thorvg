...
enum class TextWrap : uint8_t
{
    ...
    Auto,          ///< Automatically choose wrapping method: word wrap first, falling back to character wrap if a word does not fit.
...
public:
     ...
     *
     * @param[in] mode The wrapping strategy to apply. See @ref TextWrap for available options.
     *
     * @see TextWrap
     * @note Experimental API
     */
