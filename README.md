...
### Godot
ThorVG has been integrated into the [Godot](https://www.godotengine.org) project for use of neat and slick UIs in Godot editors. Godot is a completely free and open-source modern game engine, it provides a huge set of common tools, so you can just focus on making your game without reinventing the wheel.
