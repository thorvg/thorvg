...
static int HistoHeapInit(HistoHeap* const histo_heap, const int max_index) {
  ...
  histo_heap->heap = static_cast<HistogramPair*>(WebPSafeMalloc(max_index * max_index,
                                    sizeof(*histo_heap->heap)));
  histo_heap->positions = static_cast<int*>(WebPSafeMalloc(max_index * max_index,
...
static int HistogramCombineGreedy(VP8LHistogramSet* const image_histo,
  ...
  int* const clusters = static_cast<int*>(WebPSafeMalloc(image_histo_size, sizeof(*clusters)));
