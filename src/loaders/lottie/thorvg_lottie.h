...
public:
    ...
    */
     ...
     *
     * @see applySlot(uint32_t sid)
     * @see delSlot(uint32_t sid)
     *
     * @since 1.0
     */
     ...
     *
     * @param[in] sid The ID of the slot to apply. Use 0 to reset all slots.
     *
     * @retval Result::InvalidArguments If the animation is not loaded or the slot ID is invalid.
     *
     * @see genSlot(const char* slot)
     *
     * @since 1.0
     */
    Result applySlot(uint32_t sid) noexcept;

    /**
     * @brief Deletes a previously generated slot.
     *
     * This function removes a slot by its ID. If 0 is passed, all slots will be deleted.
     *
     * @param[in] sid The ID of the slot to delete. Use 0 to delete all slots.
     *
     * @retval Result::InvalidArguments If the animation is not loaded or the slot ID is invalid.
     *
     * @see genSlot(const char* slot)
     ...
     * @since 1.0
     */
    Result delSlot(uint32_t sid) noexcept;
